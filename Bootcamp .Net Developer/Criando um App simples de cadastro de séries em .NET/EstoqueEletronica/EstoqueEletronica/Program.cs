...
ComponentesRepositorio repositorio = new();
...
void SubtrairComponentes()
{
    ...
    Componentes atualizaComponente = new(Id: indiceComponentes,
...
void InserirComponentes()
{
    ...
    Componentes novoComponente = new(Id: repositorio.ProximoId(), nomeComponente: entradaNomeComponente, tipo: (Tipo)entradaTipo, infoComplementares: entradaCarcateristicaAdicionais, quantidade: entradaQuantidade);
